...
class Logger {
    constructor() {
        ...
        this._getDate = () => (new Date()).toLocaleString("pt-BR");
    }
    ...
    join(...args) {
        ...
        if (this.noColor) {
            ...
            const d = this.getDate();
            this.log(d, " ").joint()
                .color('cyan').log('>> Fui adicionado no servidor').joint()
                .log(" ").joint()
                .color('cyan').bold().log(...args);
        }
    }
    ...
    moduleStarting(...args) {
        ...
        if (this.noColor) {
            ...
            const d = this.getDate();
            this.log(d, " ").joint()
                .color('yellow').log('>> Iniciando o componente').joint()
                .log(" ").joint()
                .color('yellow').bold().log(...args);
        }
    }
    ...
    moduleStarted(...args) {
        ...
        if (this.noColor) {
            ...
            const d = this.getDate();
            this.log(d, " ").joint()
                .color('yellow').log('>> Componente').joint()
                .log(" ").joint()
                .color('yellow').bold().log(...args).joint()
                .color('yellow').log(" inicializado");
        }
    }
    ...
    serversMessage(...args) {
        ...
        if (this.noColor) {
            ...
            const d = this.getDate();
            this.log(d, " ").joint()
                .color('yellow').log('>> Servidores ativos:').joint()
                .log(" ").joint()
                .color('yellow').bold().log(...args);
        }
    }
